> 📄 **Sample report** — an example of the output produced by Step 13
> (`src/report.py`). This copy was generated **deterministically** (no judge LLM),
> so it shows the rule-based assessments only; running with a judge LLM adds an extra
> **🤖 AI Assessment** narrative to each section. Embedded charts are included in this
